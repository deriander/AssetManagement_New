            ...
            { "data": "os" },
                        {
                            "data": "status_Approval", "render": function (data, type, row) {
                                if (data === "Waiting") {
                                    return '<button type="button" class="btn btn-success" id="AccApp1Btn" data-toggle="tooltip" data-placement="top" title="Edit" onclick="return AcceptApproval2(' + row.id + ', ' + row.item_Id + ', \'' + row.email + '\')">Approve</button> <button type="button" class="btn btn-danger" id="DecAppBtn" data-toggle="tooltip" data-placement="top" title="Delete" onclick="return DeclineApproval(' + row.id + ')">Decline</button>';
                                }
                                else {
                                    return '-'
                                }
